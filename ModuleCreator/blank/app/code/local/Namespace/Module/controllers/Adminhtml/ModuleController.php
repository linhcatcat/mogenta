...
class <Namespace>_<Module>_Adminhtml_<Module>Controller extends Mage_Adminhtml_Controller_Action
{
	...
	public function massDeleteAction() {
		...
		if(!is_array($<module>Ids)){
			...
			try {
				...
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Total of %d record(s) were successfully deleted', count($<module>Ids)));
			} catch (Exception $e) {
				Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
			}
		}
	...
	public function exportCsvAction(){
		$fileName   = '<module>.csv';
		$content	= $this->getLayout()->createBlock('<module>/adminhtml_<module>_grid')->getCsv();
		$this->_prepareDownloadResponse($fileName,$content);
	}

	public function exportXmlAction(){
		$fileName   = '<module>.xml';
		$content	= $this->getLayout()->createBlock('<module>/adminhtml_<module>_grid')->getXml();
		$this->_prepareDownloadResponse($fileName,$content);
	}
}