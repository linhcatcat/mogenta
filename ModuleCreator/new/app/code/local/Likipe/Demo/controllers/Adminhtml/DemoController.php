...
class Likipe_Demo_Adminhtml_DemoController extends Mage_Adminhtml_Controller_Action
{
	...
	public function massDeleteAction() {
		...
		if(!is_array($demoIds)){
			...
			try {
				...
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Total of %d record(s) were successfully deleted', count($demoIds)));
			} catch (Exception $e) {
				Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
			}
		}
	...
	public function exportCsvAction(){
		$fileName   = 'demo.csv';
		$content	= $this->getLayout()->createBlock('demo/adminhtml_demo_grid')->getCsv();
		$this->_prepareDownloadResponse($fileName,$content);
	}

	public function exportXmlAction(){
		$fileName   = 'demo.xml';
		$content	= $this->getLayout()->createBlock('demo/adminhtml_demo_grid')->getXml();
		$this->_prepareDownloadResponse($fileName,$content);
	}
}