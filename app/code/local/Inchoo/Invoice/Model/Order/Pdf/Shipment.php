<?php
class Inchoo_Invoice_Model_Order_Pdf_Shipment extends Mage_Sales_Model_Order_Pdf_Shipment  
{
	...
	/*public function getPdf($shipments = array())
	{
		...
		$giftMessage = Mage::getModel("giftmessage/message")->load(35);//$order->getGiftMessageId());
